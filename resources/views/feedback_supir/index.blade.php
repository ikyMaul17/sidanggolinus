...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Daftar</span> Umpan Balik Supir</h4>
    ...
    $(document).ready(function() {
        ...
        $('#applyFilter').click(function() {
            ...
            if (startDate && endDate) {
                window.location.href = "{{ url('list_feedback_supir') }}?startDate=" + startDate + "&endDate=" + endDate + "&tipe=" + tipe;
            } else {
        ...
        $('#exportPdfModal').click(function() {
            ...
            if (startDate && endDate) {
                var url = "{{ url('list_feedback_supir_pdf') }}?startDate=" + startDate + "&endDate=" + endDate + "&tipe=" + tipe;
