...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Daftar</span> Halte Pulang</h4>
        ...
        <tbody class="table-border-bottom-0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ url('halte_pulang/delete', $raw->id) }}" class="btn btn-icon btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus?')">
            ...
            <div class="modal fade" id="editModal{{ $raw->id }}" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h5 class="modal-title">Edit Halte Pulang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    <form action="{{ url('halte_pulang/update', $raw->id)}}" method="post">
                        @csrf
                        @method('put')
...
<div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title">Tambah Halte Pulang</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
        <form action="{{ url('halte_pulang/store')}}" method="post">
            @csrf
